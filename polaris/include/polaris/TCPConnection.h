...
public:
    ...
    inline void setContext(const Lux::any& context) { context_ = context; }

    inline const Lux::any& getContext() const { return context_; }

    inline Lux::any* getMutableContext() { return &context_; }
